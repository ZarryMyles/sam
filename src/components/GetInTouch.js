...
const GetInTouch = ({ imageEnter, largeEnter }) => {
  return (
    ...
    >
      <div className="  text-brand-white px-5 md:px-48  pb-10 md:pb-[158px] pt-10 md:py-40  w-full   left-0 top-0  z-20  ">
        <div className="flex flex-col  md:flex-row md:items-center justify-between w-full">
          ...
          <div className="font-lora-italic w-3/4 leading-6 md:w-auto text-left tracking-[0.01em] md:tracking-1  text-base md:text-[22px]  text-brand-white  ">
            Lets create more{" "}
            <a
