...
const SocialProof = ({ textEnter, textLeave, imageEnter }) => {
  ...
  return (
    <ParallaxProvider className="w-full h-full mx-auto">
      ...
      >
        <div class=" bg-brand-lightGrey dark:bg-brand-footerGrey md:dark:bg-brand-darkGrey text-black dark:text-brand-gray w-full md:px-10 md:py-20 flex flex-col items-center justify-end relative">
          {/* <Parallax
          ...
          <Quote
            className="absolute -bottom-10 right-10 w-28 h-20 fill-black dark:fill-white "
            stroke="none"
          />
        </div>
      </div>
